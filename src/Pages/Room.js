...
import {connectSocket, sendMessage, closeSocket, on, off,isSocketConnected} from '../websocket/WebSocket';
...
function Room() {
    ...
    return (
        <Box sx={{display: 'flex', flexDirection: 'row', width: '100vw', height: '100vh', bgcolor: '#f5f5f5'}}>
            ...
            <DrawingBoard color={color} brushRadius={brushRadius} eraserActive={eraserActive} drawingData={drawingData}
                          onDraw={handleDrawSave}/>
        </Box>
    );
}
